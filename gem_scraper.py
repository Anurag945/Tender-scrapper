# gem_scraper.py (for GeM Portal, using Selenium)
...
# --- MAIN LOGIC ---
def scrape_gem():
    print("--- Checking GeM Portal using Selenium ---")
    ...
    try:
        ...
        for card in bid_cards[:15]: # Only check the top 15 bids to be efficient
            try:
                ...
                if tender_no in processed_tenders: continue
